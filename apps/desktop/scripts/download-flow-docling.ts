...
const binaries: readonly Binary[] = [
  { out: "flow-docling-aarch64-apple-darwin", name: "flow-docling-macos-arm64" },
  { out: "flow-docling-x86_64-apple-darwin", name: "flow-docling-macos-x64" },
  { out: "flow-docling-x86_64-unknown-linux-gnu", name: "flow-docling-linux-x64" },
  { out: "flow-docling-x86_64-pc-windows-msvc.exe", name: "flow-docling-windows-x64.exe" },
];
