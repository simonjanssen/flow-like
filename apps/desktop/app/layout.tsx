...
const ibmPlexMono = IBM_Plex_Mono({ subsets: ["latin"], weight: ["100", "200", "300", "400", "500", "600", "700"], preload: true });
const ibmPlexSans = IBM_Plex_Sans({ subsets: ["latin"], weight: ["100", "200", "300", "400", "500", "600", "700"], preload: true });
const jetBrainsMono = JetBrains_Mono({ subsets: ["latin"], preload: true });
const libreBaskerville = Libre_Baskerville({ subsets: ["latin"], weight: ["400", "700"], preload: true });
...
const plusJakartaSans = Plus_Jakarta_Sans({ subsets: ["latin"], preload: true });
...
const spaceMono = Space_Mono({ subsets: ["latin"], weight: ["400", "700"], preload: true });
const architectsDaughter = Architects_Daughter({ subsets: ["latin"], weight: ["400"], preload: true });
