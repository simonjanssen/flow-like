                    ...
                    <div className="flex items-center justify-between">
                        ...
                        >
                            <DialogTrigger asChild>
                                <Button size="lg" className="gap-2 shadow-lg hover:shadow-xl transition-all duration-200 bg-gradient-to-r from-primary to-primary/80">
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold">{boards.data.length}</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold">
                                                {boards.data.reduce((acc, board) => acc + Object.keys(board.nodes).length, 0)}
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold">
                                                {boards.data.reduce((acc, board) => acc + Object.keys(board.variables).length, 0)}
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <Card className="border-0 shadow-md bg-gradient-to-br from-muted/50 to-muted/20">
                            <CardContent className="flex flex-col items-center justify-center py-16">
                                ...
                                <p className="text-muted-foreground text-center mb-6 max-w-md">
                                    Create your first workflow board to start building amazing automations
                                </p>
                                <Button
