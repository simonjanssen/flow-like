		...
		<div className="w-full max-w-6xl mx-auto p-6 space-y-6 flex flex-col flex-grow max-h-full overflow-auto">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Track your projects journey from private development to public release
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-6">
					<div className="relative">
						{/* Progress Line - Hidden on mobile */}
						<div className="absolute top-6 left-6 right-6 h-0.5 bg-border -z-10 hidden md:block" />
							...
							{[
								...
								return (
									<div key={step.status} className="flex md:flex-col items-center md:items-center text-left md:text-center w-full md:max-w-[140px] gap-3 md:gap-0">
										...
										{/* Mobile: Progress line between items */}
										{index < 4 && (
											<div className="md:hidden w-px h-8 bg-border ml-5 -mt-2 -mb-2" />
										)}
									</div>
								);
							})}
						...
						<div className="flex items-start md:items-center gap-3">
							...
							<div className="flex-1">
								...
								<div className="text-xs md:text-sm text-muted-foreground mt-1">
									{localApp?.visibility === IAppVisibility.Offline &&
										"Your app is stored locally and wont sync across devices."}
									{localApp?.visibility === IAppVisibility.Private &&
										"Your app syncs across your devices but isnt shared with others."}
									{localApp?.visibility === IAppVisibility.Prototype &&
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Document whats new in this version
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					<div className="space-y-2">
						<Label htmlFor="changelog">Whats New</Label>
						<Textarea
							id="changelog"
					...
					<CardContent className="pt-6">
						<div className="flex items-center gap-2 text-blue-800 dark:text-blue-200">
							...
							<span className="text-sm">
								You dont have edit permissions for this application
							</span>
						</div>
					</CardContent>
				</Card>
