...
export default function YoursPage() {
    ...
    const [encryptedImportPath, setEncryptedImportPath] = useState<string | null>(null);
...
const ImportEncryptedDialog: React.FC<ImportEncryptedDialogProps> = ({
    ...
    const handleImport = useCallback(async () => {
        if (!path) return;
        setLoading(true);
        const toastId = toast.loading("Importing encrypted app...", { description: "Decrypting and importing. Please wait." });
        try {
            ...
            <DialogContent className="sm:max-w-md animate-in fade-in-0 slide-in-from-top-8 rounded-2xl shadow-2xl border-none bg-background/95 backdrop-blur-lg">
                ...
                <div className="flex flex-col gap-3 py-2">
                    <div className="grid gap-2">
                        <label htmlFor="import-password" className="text-xs text-muted-foreground">
                            Password
                        </label>
