import { Button, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, useInvoke, type ISettingsProfile } from "@tm9657/flow-like-ui";
...
export function TutorialDialog() {
    ...
    return <Dialog open={showTutorial} onOpenChange={(open) => setShowTutorial(open)}>
        <DialogContent>
            <DialogHeader>
                <DialogTitle>
            ...
            <div className="w-full flex flex-col items-center justify-center gap-4 border rounded-lg bg-card shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center mb-4">
                    <h3><span className="text-primary">Flow</span> Like</h3>
                    <p className="text-center leading-5">Your solution for scalable Software.</p>
                </div>
            </div>
            <DialogFooter>
