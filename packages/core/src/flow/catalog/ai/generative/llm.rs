...
pub async fn register_functions() -> Vec<Arc<Mutex<dyn NodeLogic>>> {
    let mut nodes: Vec<Arc<Mutex<dyn NodeLogic>>> = vec![
        ...
        Arc::new(Mutex::new(
            history::message::make::MakeHistoryMessageNode::default(),
        )),
        Arc::new(Mutex::new(
            history::message::push_content::PushContentNode::default(),
        )),
        Arc::new(Mutex::new(
            history::push_message::PushHistoryMessageNode::default(),
        )),
        Arc::new(Mutex::new(
            history::pop_message::PopHistoryMessageNode::default(),
        )),
        Arc::new(Mutex::new(history::clear::ClearHistoryNode::default())),
        Arc::new(Mutex::new(
            history::get_system::GetSystemPromptNode::default(),
        )),
        Arc::new(Mutex::new(
            history::set_system::SetSystemPromptMessageNode::default(),
        )),
        Arc::new(Mutex::new(
            history::set_stream::SetHistoryStreamNode::default(),
        )),
        Arc::new(Mutex::new(
            history::set_max_completion_tokens::SetHistoryMaxTokensNode::default(),
        )),
        Arc::new(Mutex::new(history::set_top_p::SetHistoryTopPNode::default())),
        Arc::new(Mutex::new(
            history::set_temperature::SetHistoryTemperatureNode::default(),
        )),
        Arc::new(Mutex::new(history::set_seed::SetHistorySeedNode::default())),
        Arc::new(Mutex::new(
            history::set_presence_penalty::SetHistoryPresencePenaltyNode::default(),
        )),
        Arc::new(Mutex::new(
            history::set_frequency_penalty::SetHistoryFrequencyPenaltyNode::default(),
        )),
        Arc::new(Mutex::new(history::set_user::SetHistoryUserNode::default())),
        Arc::new(Mutex::new(
            history::set_stop::SetHistoryStopWordsNode::default(),
        )),
        Arc::new(Mutex::new(
