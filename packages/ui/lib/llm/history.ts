...
import { type IHistory, type IStreamOptions, type IHistoryMessage, type ITool, IContentType, IRole, type IToolChoice } from "../schema/llm/history";
...
export class History implements IHistory {
    ...
    setSystemPrompt(prompt: string) {
        const system_prompt_index = this.messages.findIndex((message) => message.role === "system");
        ...
        this.messages.unshift({ role: IRole.System, content: [{ type: IContentType.Text, text: prompt }] });
    }
