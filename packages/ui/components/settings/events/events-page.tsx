...
function EventsTable({ events, boardsMap, onEdit, onDelete, onNavigateToNode, onCreateEvent }: Readonly<IEventsTableProps>) {
    ...
    const filteredEvents = useMemo(() => {
        ...
        return events.filter(event =>
            ...
            (boardsMap.get(event.board_id) ?? "").toLowerCase().includes(searchTerm.toLowerCase())
        );
                                ...
                                <TableRow key={event.id} className="hover:bg-muted/50">
                                    ...
                                    <TableCell>
                                        ...
                                        <div className="text-xs text-muted-foreground">
                                            {event.board_version ? `v${event.board_version.join(".")}` : "Latest"}
                                        </div>
                                    </TableCell>
                                    <TableCell>
