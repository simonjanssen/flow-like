...
export const ChatBox = ({
	...
	const [activeTools, setActiveTools] = useState<string[]>(defaultActiveTools);
					...
					{recordedAudio && (
						<div className="flex items-center gap-2 p-2 bg-background border border-border rounded-lg">
							...
							<Button
								...
								size="sm"
								variant="ghost"
								className="h-5 w-5 p-0 rounded-full hover:bg-destructive hover:text-destructive-foreground shrink-0"
								...
								{attachedFiles.slice(0, 6).map((file, index) => (
									...
									>
										...
										<Button
											...
											size="sm"
											variant="ghost"
											className="h-5 w-5 p-0 rounded-full bg-background border border-border opacity-0 group-hover:opacity-100 transition-opacity hover:bg-destructive hover:text-destructive-foreground shrink-0"
