...
import { Button, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, EmptyState } from "../ui";
...
export const FlowRuns = ({
    ...
    const { currentMetadata, setCurrentMetadata, currentLogs, setFilter, refetchLogs } = useLogAggregation();
    const {
        fitView
    } = useReactFlow()
    ...
    const zoomNode = useCallback((nodeId: string) => {
        fitView({
            nodes: [
                {
                    id: nodeId,
                    ...
                    .map((run) => (
                        ...
                        >
                            <div className="flex flex-col gap-2 items-start justify-center">
                                <small className="leading-none">{nodes[run.node_id]?.friendly_name ?? "Deleted Event"}</small>
                            ...
                            <div className="flex flex-row items-center gap-2">
                                <div className="flex flex-row gap-2 items-center">
                                    ...
                                    <div>
                                        {logLevelFromNumber(run.log_level) ===
                                            ILogLevel.Debug && (
