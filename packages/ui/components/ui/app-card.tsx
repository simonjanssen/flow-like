        ...
        >
            ...
            <div className="flex flex-col items-start text-left min-w-0 flex-1 gap-1">
                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    {app.visibility === IAppVisibility.Public && <div className="flex items-center gap-0 ml-3 shrink-0 h-4">
                        {app.price && app.price > 0 ? (
                            <Badge variant="outline" className="text-xs font-medium px-2 py-1 bg-primary/5">
                                €{(app.price / 100).toFixed(2)}
                            </Badge>
                        ) : (
                            <Badge variant="outline" className="text-xs font-medium px-2 py-1 bg-green-200/40 text-green-500 border-green-500 dark:bg-green-500/40 dark:text-green-200 dark:border-green-200">
                                Free
                            </Badge>
                        )}
                    </div>}
			...
			<div className="flex flex-col p-4 space-y-2 flex-1 max-w-full overflow-hidden w-full">
				...
				<div className="flex flex-row items-center justify-between w-full">
					<div className="flex items-center gap-2">
						...
						{app.visibility === IAppVisibility.Public && app.price && app.price > 0 && (
